...
const TopLanguage = () => {
  ...
  const language = [
    { id: 1, title: 'Thai', icon: 'th', image: Thai, isLang: '/th/' },
    { id: 2, title: 'English', icon: 'en', image: English, isLang: '/en/' },
    { id: 3, title: 'Arabic', icon: 'ar', image: Arabic, isLang: '/ar/' },
    { id: 4, title: 'French', icon: 'fr', image: French, isLang: '/fr/' },
    { id: 5, title: 'Spanish', icon: 'es', image: Spanish, isLang: '/es/' },
  ];
